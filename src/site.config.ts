...
export const theme: ThemeUserConfig = {
  ...
  footer: {
    ...
    social: [
      ...
      { icon: 'rss', label: 'Blog RSS', href: '/rss.xml' }
    ]
  },
...
export const integ: IntegrationUserConfig = {
  ...
  // Comment system
  waline: {
    // Kept only because astro-pure currently requires this legacy config key.
    // Comments are provided by Giscus in src/components/comments/Comment.astro.
    enable: false,
    showMeta: false,
    additionalConfigs: {}
  }
